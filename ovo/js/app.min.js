$(function () {
    function t(t, e) {
        ...
        if (!i) {
            if (d = t, o.text(m[d][0]), s.text("神马"), c.text("？"), a.addClass("shake"), cnt = 0, e) {
                var n = $(".tip").show();
                setTimeout(function () {
                    n.remove()
                }, 4e3)
    ...
    var m = [["早饭", 
        ...
        // 读取文件内容并分割成数组
        let breakfastItems = fs.readFileSync('menu.txt', 'utf8').split(" ");
        
        // 创建三维数组
        //var m = [["早饭", breakfastItems], ["午饭", []], ["晚饭", []]];
        
        // 将早饭的食物列表复制给午饭和晚饭
        m[1][1] = breakfastItems; // 使用 slice() 来复制数组
        m[2][1] = breakfastItems.slice(); // 使用 slice() 来复制数组
    ...
    a.on("animationend webkitAnimationEnd", function (t) {
        ...
        if (g.toggleClass("playing", !i), i)
            i = 0,
                ...
                clearTimeout(b),
                document.title = "小明の雜貨鋪｜" + a.text() + "这是一个很无聊的网站，但能解决你的人生一大困扰！选择困难户必备！";
        else {
            i = 1,
                cnt++,
                2 == cnt && e("我就知道你会换一个 ( ͡° ͜ʖ ͡°)"),
                5 == cnt && e("说，你是不是天秤座？Σ( ° △ °|||)︴"),
                10 == cnt && e("你是吃了炫迈吗？(￣△￣；)"),
                20 == cnt && e("难道你是处女座？ (๑•̀ㅂ•́)و✧"),
                30 == cnt && e("再换我可要报警了！( *・ω・)✄╰ひ╯");
            ...
            c.text("？"), l.find("span").text("停"), x.text(""), function o() {
                ...
                var m = $("<span class='temp'>" + i + "</span>").css({
                    top: a, left: c, color: "rgba(0,0,0," + t(7, 3) / 10 + ")", fontSize: l + "px"
                }).appendTo(r);
                b = setTimeout(o, 60)
            }()
        }
        ...
        $("#toggle span").click(function () {
            $(this).hasClass("selected") || ($(this).addClass("selected").siblings().removeClass("selected"), w = $(this).data("type"), alert("monster" == w ? "注意！前方高能！" : "还是人类好吃呢Ψ(￣∀￣)Ψ"), cnt = 0, _hmt.push(["_trackEvent", "type", "toggle", w]))
        }),
